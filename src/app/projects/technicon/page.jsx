...
function MainComponent() {
  ...
  const bentoImages = [
    { src: "/techicon/Random.png", alt: "Color Palette" },
    { src: "/techicon/Artboard 7.png", alt: "Granola Bar" },
    { src: "/techicon/Artboard 6.png", alt: "Product Packaging" },
    { src: "/techicon/Cover.png", alt: "Tote Bag" },
    { src: "/techicon/Artboard 7 copy.png", alt: "Product Display" },
  ];
    ...
    <div className="flex items-center flex-col bg-background-light dark:bg-background-dark min-h-screen">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-12">
          ...
          <div className="md:w-2/5">
            ...
            <p className="font-inter font-bold text-[32px] text-textscd-dark dark:text-textscd-dark mb-8">
              Implementation of smart lighting technologies. Creating an
              Illuminating Brand Identity for Lighting Innovations
            </p>
      ...
      <div className="w-[95%] mx-auto px-4 py-16 bg-background-dark dark:bg-background-dark flex justify-center">
        <div>
          ...
          <h3 className="font-poppins font-bold text-[36px] mb-3 text-tertiary-light dark:text-tertiary-light">
            Connecting Possibilities, Energising Life!
          </h3>
          <p className="font-inter font-bold text-[32px] text-textscd-dark dark:text-textscd-dark mb-12 max-w-3xl">
            The journey began with the birth of a symbol - the logo. In the
            logo, the wire, bulb, and the 'T' come together to represent the
            fusion of cutting-edge technology and timeless brilliance.
          </p>
          <div className="bg-background-light dark:bg-background-dark rounded-3xl p-8">
            <div className="flex justify-center items-center gap-8">
              <img
                src="/techicon/Technicon logo 2.png"
                alt="Techicon India Concept"
      ...
      <div className="w-[95%] mx-auto px-4 py-16 bg-background-dark dark:bg-background-dark flex justify-center relative">
        <div>
          ...
          <p className="font-inter font-bold text-[32px] text-textscd-dark dark:text-textscd-dark mb-16 max-w-1xl">
            Infusing precision and innovation into every design element, we
            crafted a contemporary visual narrative that perfectly mirrors
            Technicon's commitment to brilliance across diverse spaces, from
            sports stadiums to healthcare institutions to beautiful homes.
          </p>
            ...
            <div className="flex items-center gap-12 mb-16 justify-center relative">
              ...
              <div className="w-3/4 ml-[25%]">
                <div
                  ...
                  style={{ backgroundColor: "#3b6d43" }}
                >
                  <img
                    src="/techicon/Artboard 8.png"
                    alt="Tote Bag"
      ...
      >
        <div>
          ...
          <h3 className="font-poppins font-bold text-[36px] mb-8 text-text-dark dark:text-text-dark"></h3>
          <p className="font-inter font-bold text-[32px] text-textscd-dark dark:text-textscd-dark mb-16 max-w-3xl">
            Our concise guidelines harmonize modern fonts and purposeful colors,
            ensuring a consistent and impactful visual identity for Technicon.
          </p>
          <p className="font-inter font-bold text-[32px] text-textscd-dark dark:text-textscd-dark mb-16 max-w-3xl">
            We ensured a consistent and professional appearance across
            Technicon’s stationery, reinforcing a unified visual presence in
            business cards, letterheads, and other touchpoints.
          </p>
